...
# Kita hapus set_tracking_uri karena CI/CD menggunakan penyimpanan lokal default
...
# 2. MULAI RUN
    ...
    print("\n=== 6. Evaluasi ===")
    # Autolog sudah menyimpan model, jadi kita tidak perlu mlflow.keras.log_model manual
    loss, accuracy = model.evaluate(X_test_pad, y_test, verbose=1)
    
    # Log parameter tambahan jika diperlukan
